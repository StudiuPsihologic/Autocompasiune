...
class DayFiveActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_day_five)
        findViewById<WebView>(R.id.web_view_test).loadData(getString(R.string.day_five_text),
            "text/html; charset=utf-8", "utf-8")
    }

    fun finishDayFive(view: View) {
        ...
        with (sharedPref.edit()) {
            ...
            putInt("promise_text", R.string.promise_day_five)
            putInt("day_id", 6)
            apply()
        }
        ...
        webView.loadData(getString(R.string.promise_day_five),"text/html; charset=utf-8", "utf-8")
    }
}